// import 'package:firebase_auth/firebasedart';
...
import 'package:flutter/material.dart';
import 'main.dart';
import 'profile/user_specifics.dart';
import 'globals.dart' as globals;

class StudentSignupPage extends StatefulWidget {
  StudentSignupPage({Key? key, required this.title}) : super(key: key);
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            // print(user.email);
                            // user.school = schoolController.text;
                            ...
                            // use Firebase Database
                              FirebaseDatabase.instance.reference().child("students/" + value.user!.uid).set(
                                  {
