...
//
//   // late OpenAI openAI;
//   final openAI = OpenAI.instance.build(token: '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 ',baseOption: HttpSetup(receiveTimeout: const Duration(seconds: 5)),enableLog: true);
